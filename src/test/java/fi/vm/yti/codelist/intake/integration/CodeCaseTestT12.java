...
public class CodeCaseTestT12 extends AbstractIntegrationTestBase {

    private static final String CASE_TEST_CODE_FILENAME = "v1_case_insensitive_codes.csv";
    private static final String CASE_TEST_CODESCHEME = "casetest1";
