...
//    @Query(value = "SELECT u FROM UpdateStatus as u WHERE u.dataType = :dataType AND u.status = 'successful' ORDER BY u.modified DESC LIMIT 1", nativeQuery = true)
//    UpdateStatus getLatestSuccessfulUpdateForType(@Param("dataType") final String dataType);
