...
@Table(name = "code")
@XmlRootElement
@XmlType(propOrder = {"id", "codeValue", "uri", "url", "status", "hierarchyLevel", "startDate", "endDate", "modified", "prefLabel", "description", "definition", "codeScheme", "shortName", "externalReferences", "broaderCodeId",  "flatOrder", "childOrder", "conceptUriInVocabularies"})
